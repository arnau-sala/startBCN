...
export function EuropeMap({ cities, selectedCityId, onCityClick, timeframe }: EuropeMapProps) {
    ...
    return (
        /*
         * Fills container (aspect-ratio box from parent). We use an inner 1:1 container
         * so the overlay and pins always match the image perfectly regardless of parent aspect ratio.
         */
        <div className="relative w-full h-full flex items-center justify-center p-2" style={{ borderRadius: "var(--radius-md)" }}>
            {/* Inner box shrink-wraps the image so overlay percentages align perfectly */}
            <div className="relative flex items-center justify-center max-w-full">
                {/* ── Image defines natural dimensions ── */}
