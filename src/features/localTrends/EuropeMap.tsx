...
export function EuropeMap({ cities, selectedCityId, onCityClick, timeframe }: EuropeMapProps) {
    ...
    return (
        /*
         * Fills container (aspect-ratio box from parent). Image uses object-fit: contain
         * so the full map is visible without cropping. Overlay and pins match the box.
         */
        <div className="relative w-full h-full" style={{ borderRadius: "var(--radius-md)", overflow: "hidden" }}>

            {/* ── Image fills box, whole map visible (no crop) ── */}
